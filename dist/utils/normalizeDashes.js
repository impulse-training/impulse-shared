...
exports.hasFancyDash = void 0;
exports.normalizeDashes = normalizeDashes;
exports.normalizeDashesDeep = normalizeDashesDeep;
...
const NUMERIC_RANGE = new RegExp(`(\\d)[ \\t]*[${FANCY_DASH_CLASS}][ \\t]*(\\d)`, "g");
...
const hasFancyDash = (text) => new RegExp(`[${FANCY_DASH_CLASS}]`).test(text);
exports.hasFancyDash = hasFancyDash;
/**
...
function normalizeDashes(text) {
    if (!(0, exports.hasFancyDash)(text))
        return text;
    return text
 ...
 */
function normalizeDashesDeep(value) {
    if (typeof value === "string")
        return normalizeDashes(value);
    if (Array.isArray(value))
        return value.map((entry) => normalizeDashesDeep(entry));
