...
export type Tactic = ActionTactic | AffirmationTactic | AudioTactic | ImageTactic | LinkTactic | SupportTactic | VideoTactic;
...
export declare const tacticIsSupportGroupTactic: (value: Tactic) => value is SupportTactic;
export declare const isValidSupportGroupTactic: (value: unknown) => value is SupportTactic;
