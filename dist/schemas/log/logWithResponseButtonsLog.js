...
exports.logWithResponseButtonsLogSchema = exports.responseButtonSchema = void 0;
const zod_1 = require("zod");
const base_1 = require("./base");
const timestampSchema_1 = require("../../utils/timestampSchema");
exports.responseButtonSchema = zod_1.z.object({
    id: zod_1.z.string().min(1),
    label: zod_1.z.string().min(1),
    responseText: zod_1.z.string().min(1),
    style: zod_1.z.enum(["primary", "secondary", "destructive"]).optional(),
});
exports.logWithResponseButtonsLogSchema = base_1.logBaseSchema.extend({
    type: zod_1.z.literal("log_with_response_buttons"),
    ...
    data: zod_1.z.object({
        ...
        buttons: zod_1.z.array(exports.responseButtonSchema).min(1),
