...
export declare const logTypes: readonly ["user", "ai_agent", "tool_call", "tactic_completed", "tactic_viewed", "impulse_button_pressed", "behavior_tracked", "question", "gameplan", "debrief_answer", "debrief_outcome", "debrief_summary_request", "debrief_summary", "debrief_summary_edited"];
export type LogType = (typeof logTypes)[number];
export type Log = TacticLog | ImpulseLog | BehaviorTrackedLog | QuestionLog | GameplanLog | ToolCallLog | UserLog | AiAgentLog | DebriefAnswerLog | DebriefOutcomeLog | DebriefSummaryRequestLog | DebriefSummaryLog | DebriefSummaryEditedLog;
