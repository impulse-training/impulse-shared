...
const humanSupportEscalationLog_1 = require("./humanSupportEscalationLog");
const resumeRecapRemindersCtaLog_1 = require("./resumeRecapRemindersCtaLog");
...
const voiceOfferLog_1 = require("./voiceOfferLog");
const scheduledCheckInLog_1 = require("./scheduledCheckInLog");
exports.logSchemas = {
    ...
    resume_recap_reminders_cta: resumeRecapRemindersCtaLog_1.resumeRecapRemindersCtaLogSchema,
    human_support_escalation: humanSupportEscalationLog_1.humanSupportEscalationLogSchema,
    ...
    voice_offer: voiceOfferLog_1.voiceOfferLogSchema,
    scheduled_check_in: scheduledCheckInLog_1.scheduledCheckInLogSchema,
};
...
__exportStar(require("./resumeRecapRemindersCtaLog"), exports);
__exportStar(require("./humanSupportEscalationLog"), exports);
...
__exportStar(require("./voiceOfferLog"), exports);
__exportStar(require("./scheduledCheckInLog"), exports);
...
exports.logSchema = zod_1.z.discriminatedUnion("type", [
    ...
    resumeRecapRemindersCtaLog_1.resumeRecapRemindersCtaLogSchema,
    humanSupportEscalationLog_1.humanSupportEscalationLogSchema,
    ...
    voiceOfferLog_1.voiceOfferLogSchema,
    scheduledCheckInLog_1.scheduledCheckInLogSchema,
]);
// Export log type guards
const logIsScheduledCheckInLog = (value) => value.type === "scheduled_check_in";
exports.logIsScheduledCheckInLog = logIsScheduledCheckInLog;
const isValidScheduledCheckInLog = (value) => {
    return scheduledCheckInLog_1.scheduledCheckInLogSchema.safeParse(value).success;
};
exports.isValidScheduledCheckInLog = isValidScheduledCheckInLog;
const logIsVoiceOfferLog = (value) => value.type === "voice_offer";
exports.logIsVoiceOfferLog = logIsVoiceOfferLog;
const isValidVoiceOfferLog = (value) => {
    return voiceOfferLog_1.voiceOfferLogSchema.safeParse(value).success;
};
exports.isValidVoiceOfferLog = isValidVoiceOfferLog;
...
const logIsVoiceTurn = (value) => {
    var _a;
    return (value.type === "user_message" || value.type === "assistant_message") &&
        !!((_a = value.voice) === null || _a === void 0 ? void 0 : _a.callLogId);
};
exports.logIsVoiceTurn = logIsVoiceTurn;
...
const logIsResumeRecapRemindersCtaLog = (value) => value.type === "resume_recap_reminders_cta";
exports.logIsResumeRecapRemindersCtaLog = logIsResumeRecapRemindersCtaLog;
const isValidResumeRecapRemindersCtaLog = (value) => {
    return resumeRecapRemindersCtaLog_1.resumeRecapRemindersCtaLogSchema.safeParse(value).success;
};
exports.isValidResumeRecapRemindersCtaLog = isValidResumeRecapRemindersCtaLog;
const logIsHumanSupportEscalationLog = (value) => value.type === "human_support_escalation";
exports.logIsHumanSupportEscalationLog = logIsHumanSupportEscalationLog;
const isValidHumanSupportEscalationLog = (value) => {
    return humanSupportEscalationLog_1.humanSupportEscalationLogSchema.safeParse(value).success;
};
exports.isValidHumanSupportEscalationLog = isValidHumanSupportEscalationLog;
...
const logIsWeekOverviewLog = (value) => value.type === "week_overview";
exports.logIsWeekOverviewLog = logIsWeekOverviewLog;
const isValidWeekOverviewLog = (value) => {
    return weekOverviewLog_1.weekOverviewLogSchema.safeParse(value).success;
};
exports.isValidWeekOverviewLog = isValidWeekOverviewLog;
const logIsProposedGoalChangeLog = (value) => value.type === "proposed_goal_change";
exports.logIsProposedGoalChangeLog = logIsProposedGoalChangeLog;
const isValidProposedGoalChangeLog = (value) => {
...
const logIsPhotoLog = (value) => value.type === "photo";
...
const logIsCoachBookingPromptLog = (value) => value.type === "coach_booking_prompt";
exports.logIsCoachBookingPromptLog = logIsCoachBookingPromptLog;
const logIsDebriefQuestionLog = (value) => value.type === "debrief_question";
exports.logIsDebriefQuestionLog = logIsDebriefQuestionLog;
const logIsPlanHistoryEntryLog = (value) => value.type === "plan_history_entry";
exports.logIsPlanHistoryEntryLog = logIsPlanHistoryEntryLog;
