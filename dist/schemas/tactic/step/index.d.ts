...
export declare const stepIsAudioStep: (step: TacticStep) => step is AudioStep;
...
export type { AudioStep, BreathingStep, DefaultStep, MediaStep, PedometerStep, NotifySupportStep, QuestionStep, };
