...
exports.matchingModeSchema = zod_1.default.enum(["focused", "mixed"]);
// Support Group Member Schema
exports.supportGroupMemberSchema = zod_1.default.object({
...
// Support Group Type
exports.supportGroupTypeSchema = zod_1.default.enum([
    "system",
    "social",
    "coach",
    "alignment",
...
exports.supportGroupSchema = zod_1.default.object({
    id: zod_1.default.string().optional(), // IDS are never passed when creating
    ...
    memberIds: zod_1.default.array(zod_1.default.string()).default([]), // For efficient array-contains queries
    unreadMessageCountsById: (0, objectOf_1.objectOf)(zod_1.default.number()),
