...
exports.threadSchema = zod_1.z.discriminatedUnion("type", [
    ...
    alignment_1.alignmentThreadSchema,
...
const threadIsAlignmentThread = (value) => value.type === "alignment";
exports.threadIsAlignmentThread = threadIsAlignmentThread;
const isValidAlignmentThread = (value) => alignment_1.alignmentThreadSchema.safeParse(value).success;
exports.isValidAlignmentThread = isValidAlignmentThread;
