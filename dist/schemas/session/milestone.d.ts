import { z } from "zod";
export declare const milestoneSessionSchema: z.ZodObject<{
    ...
    morningCheckIn: z.ZodOptional<z.ZodObject<{
        deliveredAt: z.ZodType<import("../../types").Timestamp, z.ZodTypeDef, import("../../types").Timestamp>;
        deliveredAs: z.ZodEnum<["call", "push"]>;
        dateString: z.ZodString;
    }, "strip", z.ZodTypeAny, {
        dateString: string;
    ...
    type: z.ZodLiteral<"milestone">;
    milestoneAchievementId: z.ZodString;
    milestoneBehaviorId: z.ZodString;
