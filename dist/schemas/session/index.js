...
const sessionIsTasksSession = (value) => value.type === "tasks";
exports.sessionIsTasksSession = sessionIsTasksSession;
const isValidTasksSession = (value) => tasks_1.tasksSessionSchema.safeParse(value).success;
exports.isValidTasksSession = isValidTasksSession;
