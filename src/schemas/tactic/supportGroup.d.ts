...
export declare const supportGroupTacticSchema: yup.ObjectSchema<{
    id: string | undefined;
    type: "supportGroup";
    ...
    data: {
        supportGroupDoc?: import("../../utils/documentReferenceSchema").DocumentReferenceLike<unknown> | undefined;
