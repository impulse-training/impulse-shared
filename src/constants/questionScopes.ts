 ...
 */
export const getQuestionScopeLabel = (scope: QuestionScopeKey | null | undefined) => {
 ...
 */
export const getQuestionScopeDescription = (scope: QuestionScopeKey | null | undefined) => {
  if (!scope || !(scope in QUESTION_SCOPES)) {
    return '';
  }
